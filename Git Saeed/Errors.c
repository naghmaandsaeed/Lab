...
Error errors[] = {
        ...
        {-1,            ""},
        {-1,            ""},
        {ERROR_CODE_28, "Missing '=' after constant name"},
        {ERROR_CODE_29, "More '=' than needed"},
	...
	{ERROR_CODE_60, "Missing constant name after define"},
	{ERROR_CODE_60, "Missing constant name after define"},
	{ERROR_CODE_61, "Missing constant value"},
	{ERROR_CODE_62, "Illegal constant name"},
	{ERROR_CODE_63, "Illegal number"}
};
