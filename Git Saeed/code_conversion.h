...
#define SOURCE_BITS_SHIFT 4 /* number of shift left needed to reach the source operand LSB 4-5 */
#define OPCODE_BITS_SHIFT 6 /* number of shift left needed to reach the opcode LSB 6-9 */
#define DEST_BITS_SHIFT 2 /* number of shift left needed to reach the dest operand LSB 2-3 */

#define SOURCE_BITS_SHIFT_REG 5 /* number of shift left needed to reach the source register operand LSB 5-7 */
#define DEST_BITS_SHIFT_REG 2 /* number of shift left needed to reach the dest register operand LSB 2-4 */
